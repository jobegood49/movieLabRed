...
export interface Config extends Pick<GraphQLOptions<Context<any>>, 'formatError' | 'debug' | 'rootValue' | 'formatParams' | 'validationRules' | 'formatResponse' | 'fieldResolver' | 'cacheControl' | 'tracing' | 'dataSources' | 'cache'> {
